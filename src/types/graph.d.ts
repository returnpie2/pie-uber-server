...
export interface Muataion {
  EditPlace: EditPlaceResponse;
}

export interface EditPlaceMuataionArgs {
  placeId: number;
  name: string | null;
  isFav: boolean | null;
}
